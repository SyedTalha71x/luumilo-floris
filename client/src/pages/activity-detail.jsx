...
import { ArrowLeft, Clock, Users, Star, CheckCircle, Target, Brain, Heart } from "lucide-react";
...
function ActivityDetail() {
    ...
    const activities = [
        {
            ...
            effect: "Stimuleert probleemoplossend vermogen, vergroot de fijne motoriek en stimuleert creativiteit door te experimenteren met verschillende materialen en structuren.",
    ...
    const activityData = activities.find(activity => activity.id === parseInt(id)) || activities[0];
    ...
    // Color mapping for activity headers
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-6xl mx-auto p-4 lg:p-6">
                <div className="px-4 py-3">
                    <button
                        onClick={handleBack}
                        className="flex items-center text-[#262F40] cursor-pointer transition-colors"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6 p-4 rounded-2xl bg-[#F1F6FB]">
                        <div className={`${getColorClasses(activityData.color)} rounded-2xl text-white p-8 text-center`}>
                            ...
                            <h1 className="text-2xl lg:text-3xl inter-tight-700 font-bold leading-tight">
                                {activityData.title}
                            </h1>
                        ...
                        <div className=" rounded-2xl p-3">
                            <h2 className="text-lg poppins-700 font-semibold mb-3 flex items-center text-[#111827]">
                                <div className="w-6 h-6  rounded-full flex items-center justify-center mr-1">
                                    <div>
                                        <img src={DetailImage2} alt="" />
                                    </div>
                                </div>
                                Effect op het kind              </h2>
                            <p className="text-[#374151] inter-tight-400 text-md leading-relaxed">
                                {activityData.effect}
                            </p>
                        </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-3xl shadow-lg border border-[#E2E4E9] p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-sm inter-tight-700 font-medium text-[#1F1F1F]">{activityData.rating} / 10</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl shadow-lg border border-[#E2E4E9] p-6">
                            ...
                            <div className="flex items-center space-x-3">
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${getIconColorClasses(activityData.color)}`}>
                                    <img src={activityData.image} alt="" />
                                </div>
                                <div>

          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <button
                id="age-group"
                type="button"
                className="w-full bg-[#F7FAFC] border border-gray-300 rounded-md py-2 px-3 text-left outline-none text-sm"
                aria-haspopup="listbox"
              >
                <span className="flex items-center justify-between">
                  <span className="text-[#575757]">Age 3-4</span>
                  <ChevronDown className="h-5 w-5 text-[#575757]" />
                </span>
              </button>
            </div>
